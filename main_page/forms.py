...
class UserReservationForm(forms.ModelForm):
    ...
    e_mail = forms.CharField(max_length=50, widget=forms.TextInput(attrs={
                                                'type': "email",
                                                'class': "form-control",
                                                'name': "email",
                                                'id': "email",
...
#    date_order = forms.DateField(widget=forms.DateInput)

    class Meta:
        model = UserReservation
        fields = ('name', 'e_mail', 'phone', 'persons', 'message')